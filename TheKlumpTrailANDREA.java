...
class KlumpFrame extends JFrame implements ActionListener { // Frame
    ...
    public void configureUI() {
        ...
        lblStory.setText("<html>The year is 2020 and summer vacation has just started.<br />"
                        + "Despite that, Dr. Klump has woken up at 7:00 am and exclaimed<br />"
                        + "\"I can't wait to go to this ACDC concert at 10 in the morning!<br />"
                        + "I wonder what I should wear...\"</html>");
